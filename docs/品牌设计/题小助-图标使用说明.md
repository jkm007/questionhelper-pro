...
├── app-icon-{size}.png          # 标准版 PNG (17个尺寸)
├── app-icon-simple-{size}.png   # 简化版 PNG
├── app-icon-mascot-{size}.png   # IP形象 PNG
├── app-icon-circle-{size}.png   # 圆形版 PNG
├── app-icon-minimal-{size}.png  # 极简版 PNG
└── favicon/
...
总计：5 SVG + 85 PNG + 1 ICO + 2 SVG (favicon) + 9 PNG (favicon) = **102 个文件**
